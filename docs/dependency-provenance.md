...
| --- | --- | --- |
| `zed-pkg/zed-lib-core` | `fc4f2677a2315d522913bef05a1c0d23f8208960` | Canonical `zed-orm-core` read-only data plane |
| `zed-pkg/zed-interfaces` | `b795c92126202cd1e4bd2365eb58d8cefa2095c3` | Polyglot package and API contract workspace |
